...
// If you import the logo
// import Logo from "../assets/images/logos/logo.svg"; // adjust path
...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/auth/register", {  // ← Relative URL!
        method: "POST",
              ...
              <div className="card mb-0">
                <div className="card-body">
                  <Link to="/" className="text-nowrap logo-img text-center d-block py-3 w-100">
                    <img src="/assets/images/logos/logo.svg" alt="logo" /> {/* ← Fixed path */}
                    {/* Or if imported: <img src={Logo} alt="logo" /> */}
                  </Link>
